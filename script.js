...
const iconMap = {
  clear: "☀️", clouds: "☁️", rain: "🌧️", snow: "❄️", thunderstorm: "⛈️", mist: "🌫️", haze: "🌫️",
  drizzle: "🌦️", fog: "🌁", windy: "🌬️"
};
...
const apiKey ="931f6beadfef0401077b236b146e77c4";
...
`;
      ...
      getForecast(data.coord.lat, data.coord.lon, currentUnit === "metric" ? "°C" : "°F");
    } else {
      weatherBg.style.display = "none";
      weatherBg.src = "";
      document.getElementById("weather-result").style.display = "flex";
...
async function getForecast(lat, lon, tempUnit) {
